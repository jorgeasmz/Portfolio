...
This is the series the project previously used on its own, evaluated on a single
split of the final twelve months. Under that split Prophet reduced the error of
the seasonal naive by roughly a third. Across four folds the ordering reverses:
